...
// All of the below should go in the service test!
...
describe('recipe_list_controller testing clear_filter function', function () {
    var $scope, mock_recipe_service, httpBackend;
...
describe('recipe_list_controller testing filter_table_rows function', function () {
    var $scope, mock_recipe_service, httpBackend;
